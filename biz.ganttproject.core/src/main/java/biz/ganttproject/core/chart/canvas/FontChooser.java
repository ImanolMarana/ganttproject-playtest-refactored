...
public class FontChooser {
  ...
  private Font loadFont(String style) {
    ...
    try {
      ...
      if (family.isEmpty()) {
        return myBaseFont.get().deriveFont(absoluteSize);
      } else {
        Font f = Font.decode(family + " 10");
        return f.deriveFont(absoluteSize);
      }
