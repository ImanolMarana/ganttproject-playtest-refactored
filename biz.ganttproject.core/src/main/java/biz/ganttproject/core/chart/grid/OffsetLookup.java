...
public class OffsetLookup {
  ...
  return findOffsetInternal(point, comparator, start, end, offsets);
}

private <Type> int findOffsetInternal(Type point, ComparatorBy<Type> comparator, int start, int end, List<Offset> offsets) {
