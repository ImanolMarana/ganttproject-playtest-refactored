...
public class DateParser {
 ...
 throws InvalidDateException {
  ...
  try {
   ...
   calendar = parseMonth(st, calendar);
   if (calendar == null){
    return calendar;
   }
   calendar = parseDay(st, calendar);
   if (calendar == null){
    return calendar;
   }
   calendar = parseHour(st, calendar);
   if (calendar == null){
    return calendar;
   }
   calendar = parseMinutes(st, calendar);
   if (calendar == null){
    return calendar;
   }
   calendar = parseSeconds(st, calendar);
   
   // Timezone
   if (st.hasMoreTokens() && !st.nextToken().equals("Z")) { 
    calendar = parseTimeZone(st, calendar);
   }
 ...
 private static Calendar parseMonth(StringTokenizer st, Calendar calendar) throws InvalidDateException {
 ...
 private static Calendar parseDay(StringTokenizer st, Calendar calendar) throws InvalidDateException {
  // Day
  if (check(st, "-") && (st.hasMoreTokens())) {
 ...
 private static Calendar parseHour(StringTokenizer st, Calendar calendar) throws InvalidDateException {
  // Hour
 ...
 private static Calendar parseMinutes(StringTokenizer st, Calendar calendar) throws InvalidDateException {
  // Minutes
  if (check(st, ":") && (st.hasMoreTokens())) {
 ...
 private static Calendar parseSeconds(StringTokenizer st, Calendar calendar) throws InvalidDateException {
  // Secondes
  if (!st.hasMoreTokens()) {
   return calendar;
  }
 ...
 private static Calendar parseTimeZone(StringTokenizer st, Calendar calendar) throws InvalidDateException {
  String tok = st.nextToken();
