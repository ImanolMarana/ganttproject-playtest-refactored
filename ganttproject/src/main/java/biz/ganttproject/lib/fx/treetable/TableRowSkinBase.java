...
public abstract class TableRowSkinBase<T,
  ...
  void updateCells(boolean resetChildren) {
        ...
        updateCellsContent(resetChildren);
      }
    
      private void updateCellsContent(boolean resetChildren){
        ...
        updateChildren(resetChildren, cellsEmpty);
      }
    
      private R getOrCreateCell(TableColumnBase<T, ?> col){
        R cell = null;
      ...
      private void updateChildren(boolean resetChildren, boolean cellsEmpty){
        if (fixedCellSizeEnabled) {
