...
//        return pw;
  ...
  @Override protected void layoutChildren(final double x, double y,
    ...
    layoutTableHeader(x, y, w, baselineOffset);

    double flowHeight = Math.floor(h - tableHeaderRow.prefHeight(-1));
    layoutContent(x, y, w, flowHeight, baselineOffset);

    layoutColumnReorderOverlay(w, flowHeight);
  ...
  private void layoutTableHeader(double x, double y, double w, double baselineOffset) {
  ...
  private void layoutContent(double x, double y, double w, double flowHeight, double baselineOffset) {
  ...
  private void layoutColumnReorderOverlay(double w, double flowHeight) {
    ...
    if (tableHeaderRow.getReorderingRegion() != null) {
      ...
      if (reorderingColumn != null) {
        ...
        double overlayWidth = calculateOverlayWidth(w, minX, reorderingColumnHeader);

        double contentAreaHeight = calculateContentAreaHeight(flowHeight);
  ...
  private double calculateOverlayWidth(double w, double minX, TableColumnHeader reorderingColumnHeader) {
  ...
  private double calculateContentAreaHeight(double flowHeight) {
