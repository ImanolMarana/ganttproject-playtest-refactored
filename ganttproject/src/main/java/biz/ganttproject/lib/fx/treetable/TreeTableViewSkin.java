...
//        control.setInputMap(behavior.getInputMap());
  ...
  protected void executeAccessibleAction(AccessibleAction action, Object... parameters) {
        switch (action) {
            case SHOW_ITEM:
                showItemAction(parameters);
                break;
            case SET_SELECTED_ITEMS:
                setSelectedItemsAction(parameters);
                break;
            default:
    ...
    private void setSelectedItemsAction(Object[] parameters) {
    ...
    private void showItemAction(Object[] parameters) {
