...
public class CalendarEditorPanel {
  ...
  private static AbstractTableAndActionsComponent<CalendarEvent> createTableComponent(final TableModelImpl tableModel, final DateFormat dateFormat, UIFacade uiFacade) {
        ...
        setupDateColumn(table, dateFormat);
        setupColorColumn(table, tableModel, uiFacade);

        AbstractTableAndActionsComponent<CalendarEvent> tableAndActions = createTableAndActionsComponent(table, tableModel);
    ...
    private static void setupDateColumn(JTable table, DateFormat dateFormat) {
    ...
    private static void setupColorColumn(JTable table, TableModelImpl tableModel, UIFacade uiFacade) {
    ...
    private static AbstractTableAndActionsComponent<CalendarEvent> createTableAndActionsComponent(JTable table, TableModelImpl tableModel) {
        return new AbstractTableAndActionsComponent<>(table) {
            @Override
