...
public class ChartModelImpl extends ChartModelBase {
  ...
  private ChartItem findTaskBoundaryItem(int x, int y) {
        ...
        result = findTaskBoundaryItemFromActivity(x, rect, primitive);
        return result;
    }
    
    private ChartItem findTaskBoundaryItemFromActivity(int x, Canvas.Polygon rect, Canvas.Shape primitive) {
        ChartItem result = null;
