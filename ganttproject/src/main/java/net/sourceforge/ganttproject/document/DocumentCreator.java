...
public class DocumentCreator implements DocumentManager {
  ...
  private Document createDocument(String path, File relativePathRoot, String user, String pass) {
    ...
    if (lowerPath.startsWith("http://") || lowerPath.startsWith("https://")) {
      return createHttpDocument(path, user, pass);
    } else if (lowerPath.startsWith("cloud://")) {
      return createCloudDocument(lowerPath);
    ...
    return createFileDocument(path, relativePathRoot);
  }

  private Document createHttpDocument(String path, String user, String pass) {
    try {
  ...
  private Document createCloudDocument(String lowerPath) {
  ...
  private Document createFileDocument(String path, File relativePathRoot) {
