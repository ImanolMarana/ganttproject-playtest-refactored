      ...
      private void setupResourcesTable() {
        ...
        resourcesTable.getColumnModel().getColumn(0).setCellRenderer(new DefaultTableCellRenderer() {
          ...
          public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected,
            ...
            return EditableList.this.getTableCellRendererComponent(this, typedValue, isSelected, hasFocus,
                row);
          }
        });
        ...
        resourcesTable.getColumnModel().getColumn(0).setCellEditor(new DefaultCellEditor(editorField) {
          ...
          public Component getTableCellEditorComponent(JTable table, Object value, boolean isSelected, int row,
              int column) {
            isCanceled = false;
            JTextField result = (JTextField) super.getTableCellEditorComponent(table, value, isSelected,
                row, column);
