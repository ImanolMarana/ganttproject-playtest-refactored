...
public abstract class TextFieldAndFileChooserComponent extends JPanel {
  ...
  private void setupFileChooser(JFileChooser fc) {
    removeDefaultFileFilters(fc);
    addCustomFileFilters(fc);
    fc.doLayout();
  }

  private void removeDefaultFileFilters(JFileChooser fc) {
  ...
  private void addCustomFileFilters(JFileChooser fc) {
  ...
  private void showFileChooserDialog(JFileChooser fc) {
    Action[] dialogActions = createDialogActions(fc);
    myUiFacade.createDialog(fc, dialogActions, "").show();
  }

  private Action[] createDialogActions(final JFileChooser fc) {
