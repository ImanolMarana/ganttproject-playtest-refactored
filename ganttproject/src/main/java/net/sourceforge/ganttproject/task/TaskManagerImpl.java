...
public class TaskManagerImpl implements TaskManager {
  ...
  public TimeDuration createLength(String lengthAsString) throws DurationParsingException {
        ...
        try {
            currentLength = parseDuration(lengthAsString);
    ...
    private TimeDuration parseDuration(String lengthAsString) throws DurationParsingException {
        int state = 0;
        ...
        for (int i = 0; i < lengthAsString.length(); i++) {
            ...
            switch (state) {
                case 0:
                    currentLength = handleState0(nextChar, currentValue, valueBuffer, currentLength);
                    break;
                case 1:
                    currentLength = handleState1(nextChar, currentValue, valueBuffer, currentLength);
                    break;
                case 2:
                    currentLength = handleState2(nextChar, currentValue, valueBuffer, currentLength);
                    break;
            }
        }
        return handleTrailingValue(currentValue, valueBuffer, currentLength);
    }

    private TimeDuration handleState0(char nextChar, Integer currentValue, StringBuilder valueBuffer,
            TimeDuration currentLength) throws DurationParsingException {
    ...
    private TimeDuration handleState1(char nextChar, Integer currentValue, StringBuilder valueBuffer,
            TimeDuration currentLength) throws DurationParsingException {
        if (Character.isDigit(nextChar)) {
            valueBuffer.append(nextChar);
            return currentLength;
    ...
    private TimeDuration handleState2(char nextChar, Integer currentValue, StringBuilder valueBuffer,
            TimeDuration currentLength) throws DurationParsingException {
        if (Character.isDigit(nextChar)) {
            valueBuffer.append(nextChar);
            return currentLength;
        } else if (Character.isWhitespace(nextChar)) {
            return handleWhitespaceInState2(currentValue, valueBuffer, currentLength);
        } else {
            valueBuffer.append(nextChar);
            return currentLength;
        }
    ...
    private TimeDuration handleWhitespaceInState2(Integer currentValue, StringBuilder valueBuffer,
            TimeDuration currentLength) throws DurationParsingException {
    ...
    private TimeDuration handleTrailingValue(Integer currentValue, StringBuilder valueBuffer,
            TimeDuration currentLength) {
        if (currentValue != null) {
            currentValue = Integer.valueOf(valueBuffer.toString());
